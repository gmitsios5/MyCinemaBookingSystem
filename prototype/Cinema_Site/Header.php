<!-- HEADER OF MAIN PAGE WITH THE OPTION DEPENDS ON WHAT ROLE HAS THE LOGGED IN USER -->
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="display:<?php echo $none_uname; ?>">
					...
					<div class="dropdown-menu">
						...
						<form method="post" action="index.php#My_tickets" style="display:<?php echo $mytickets_none;?>">
							<input type="submit"  class="dropdown-item" name="mytickets"  value="My Tickets">
						</form>
